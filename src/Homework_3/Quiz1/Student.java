...
public class Student extends Q1{
    ...
    // Constructor 2: Constructor with department, studentID, and gender parameters
    public Student(String department, String studentID, String gender) {
    ...
    public Student(String department, String studentID, String gender, double height, double weight) {
        this.department = department;
        this.studentID = studentID;
        this.gender = gender;
        this.height = height;
